...
void addPart(participant* participant0){
    ...
    for(i=0;choice!='0';i++){
        ...
        fscanf(FilePointer, PARTICIPANT_FORMAT_IN, &participant0->numOfPart, participant0->firstName, participant0->secondName, &participant0->age);
    ...
    for (i=0;i<4;i++){
        printf(PARTICIPANT_FORMAT_OUT,participant0->numOfPart, participant0->firstName, participant0->secondName, participant0->age);
    }
